...
const PDFDocument = ({ nome, rg, cpf, modelo, serie, patrimonio, date, month, imei, celular }) => (
    <Document>
        <Page size="A4" style={styles.page}>
            <View style={styles.section}>
                ...
                <Text style={styles.text1}>
                    Considerando que para viabilização do contrato acima referido a <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> adquiriu Celulares e Carregadores,
                ...
                <Text>
                    Este Contrato tem como objetivo a cessão, em regime de comodato, por parte da <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> ao(a) <Text style={{ fontFamily: 'Helvetica-Bold' }}> COMODATÁRIO (A), </Text> do <Text style={{ fontFamily: 'Helvetica-Bold', textTransform: 'uppercase' }}> Celular {modelo}</Text> e
                    carregador (“Celular”), descrito abaixo, cuja entrega ocorre no ato de assinatura deste Contrato.
                </Text>
                <View>
                    <Text style={styles.specs}>Modelo: {modelo}</Text>
                    <Text style={styles.specs}>Nº SÉRIE: {serie}</Text>
                    <Text style={styles.specs}>IMEI: {imei}</Text>
                    <Text style={styles.specs}>Nº PATRIMÔNIO: {patrimonio}</Text>
                    <Text style={styles.specs}>Nº CELULAR: {celular}</Text>
                ...
                <Text>
                    Parágrafo Único – Uma vez comunicada a rescisão do Contrato, o (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> se obriga a cessar de imediato, a utilização do Celular,
            ...
            <View style={styles.section}>
                ...
                <View style={styles.text3}>
                    <Text style={styles.text2}>
                        I. Devolver o Celular e carregador nas mesmas condições em que os recebeu, ressalvado o desgaste natural,
                        decorrente do uso normal e regular;
                    </Text>
                    <Text style={styles.text2}>
                        II. Zelar pela integridade do Celular e seus acessórios, identificados na cláusula primeira deste contrato,
                        mantendo-os sob sua responsabilidade, e em perfeitas condições de funcionamento;
                    </Text>
                    <Text style={styles.text2}>
                        III. Arcar com as despesas necessárias ao reparo do Celular e/ou de seu carregador, bem como eventuais reposições no caso de
                        ocorrência de danos, provenientes do Celular, e/ou de seu carregador pelo (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A);</Text>
                    </Text>
                    <Text style={styles.text2}>
                        IV. Informar, imediatamente, à <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> os casos de defeitos do Celular, e/ou de seu carregador, para que esta adote as medidas pertinentes;
                    </Text>
                    <Text style={styles.text2}>
                        V. Comunicar, imediatamente, à <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> os casos de extravio, furto ou roubo do Celular, e/ou de seu carregador,
                    ...
                    <Text style={styles.text2}>
                        VI. Devolver o Celular e seu carregador cedidos em comodato durante os períodos de férias e licenças, iguais ou superiores a
                ...
                <Text>
                    Entregar ao(à) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO(A)</Text> o Celular, assim como o(s) acessório(s), em perfeito estado de uso e funcionamento.
                </Text>
                <Text style={styles.subtitulo}>CLÁUSULA QUINTA – DO RESSARCIMENTO EM CASO DE PERDA OU EXTRAVIO</Text>
                <Text>
                    O <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> reconhece que a perda ou extravio do Celular e seu carregador ensejará o ressarcimento
                ...
                <Text>
                    ...
                    em sua imediata rescisão, com a consequente devolução do Celular, objeto do presente, sem prejuízo da cobrança de
        ...
        <Page size="A4" style={styles.page}>
            <View style={styles.section}>
                ...
                <Text>
                    O (A) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> tem conhecimento que o Celular ora cedido é para uso exclusivo no exercício de suas funções,
                ...
                <Text>
                    O (A) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> só deverá transportar o Celular, para ambiente externo à empresa, quando demandado pelo seu gestor imediato,
                    mediante solicitação expressa;
                </Text>
                <Text>
                    Nas ocasiões em que o (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> desejar transportar o Celular, para ambiente externo à Agille, sem demanda para a Agille,
                    assume total responsabilidade sobre o bem comodatado.
                </Text>
                <Text>
                    Parágrafo Único – O Celular será de uso exclusivo do (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text>, não devendo ceder a qualquer outra
...
const ContratosCelAgille = () => {
    ...
    return (
        <Container>
            ...
            />
            <Input
                placeholder='PATRIMÔNIO CELULAR'
                value={patrimonio}
            ...
            <PDFDownloadLink style={styles.button} document={<PDFDocument
                ...
                imei={imei}
                celular={celular}
            />} fileName={`Contrato de Comodato Agille Soluções Corporativas CELULAR - ${nome}.pdf`}  >
...
export default ContratosCelAgille