    ...
    <Document>
        <Page size="A4" style={styles.page}>
            <View style={styles.section}>
                ...
                <Text>
                    ...
                    inscrita no CNPJ sob o número 36.503.186/0001-49, com sede na Rua Victor Civita, nº. 77, Bloco 1 Sala 402 - Jacarepaguá, Rio de Janeiro, RJ, doravante denominada <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> ,
                ...
                <Text style={styles.text1}>
                    Considerando que para viabilização do contrato acima referido a <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> adquiriu Tablet e Carregadores,
                ...
                <Text>
                    Este Contrato tem como objetivo a cessão, em regime de comodato, por parte da <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> ao(a) <Text style={{ fontFamily: 'Helvetica-Bold' }}> COMODATÁRIO (A), </Text> do <Text style={{ fontFamily: 'Helvetica-Bold', textTransform: 'uppercase' }}> Tablet {modelo}</Text> e
                    carregador (“Tablet”), descrito abaixo, cuja entrega ocorre no ato de assinatura deste Contrato.
                </Text>
                <View>
                ...
                <Text>
                    Parágrafo Único – Uma vez comunicada a rescisão do Contrato, o (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> se obriga a cessar de imediato, a utilização do Tablet,
            ...
            <View style={styles.section}>
                ...
                <View style={styles.text3}>
                    <Text style={styles.text2}>
                        I. Devolver o Tablet e carregador nas mesmas condições em que os recebeu, ressalvado o desgaste natural,
                        decorrente do uso normal e regular;
                    </Text>
                    <Text style={styles.text2}>
                        II. Zelar pela integridade do Tablet e seus acessórios, identificados na cláusula primeira deste contrato,
                        mantendo-os sob sua responsabilidade, e em perfeitas condições de funcionamento;
                    </Text>
                    <Text style={styles.text2}>
                        III. Arcar com as despesas necessárias ao reparo do Tablet e/ou de seu carregador, bem como eventuais reposições no caso de
                        ocorrência de danos, provenientes do Tablet, e/ou de seu carregador pelo (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A);</Text>
                    </Text>
                    <Text style={styles.text2}>
                        IV. Informar, imediatamente, à <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> os casos de defeitos do Tablet, e/ou de seu carregador, para que esta adote as medidas pertinentes;
                    </Text>
                    <Text style={styles.text2}>
                        V. Comunicar, imediatamente, à <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODANTE</Text> os casos de extravio, furto ou roubo do Tablet, e/ou de seu carregador,
                        ...
                        o seguro do dispositivo;
                    </Text>
                    <Text style={styles.text2}>
                        VI. Devolver o Tablet e seu carregador cedidos em comodato durante os períodos de férias e licenças, iguais ou superiores a
                ...
                <Text>
                    Entregar ao(à) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO(A)</Text> o Tablet, assim como o(s) acessório(s), em perfeito estado de uso e funcionamento.
                </Text>
                <Text style={styles.subtitulo}>CLÁUSULA QUINTA – DO RESSARCIMENTO EM CASO DE PERDA OU EXTRAVIO</Text>
                <Text>
                    O <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> reconhece que a perda ou extravio do Tablet e seu carregador ensejará o ressarcimento
                ...
                <Text>
                    ...
                    em sua imediata rescisão, com a consequente devolução do Tablet, objeto do presente, sem prejuízo da cobrança de
        ...
        <Page size="A4" style={styles.page}>
            <View style={styles.section}>
                ...
                <Text>
                    O (A) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> tem conhecimento que o Tablet ora cedido é para uso exclusivo no exercício de suas funções,
                ...
                <Text>
                    O (A) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> só deverá transportar o Tablet, para ambiente externo à empresa, quando demandado pelo seu gestor imediato,
                    mediante solicitação expressa;
                </Text>
                <Text>
                    Nas ocasiões em que o (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> desejar transportar o Tablet, para ambiente externo à Agille, sem demanda para a Agille,
                    assume total responsabilidade sobre o bem comodatado.
                </Text>
                <Text>
                    Parágrafo Único – O Tablet será de uso exclusivo do (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text>, não devendo ceder a qualquer outra
    ...
    return (
        <Container>
            ...
            <PDFDownloadLink style={styles.button} document={<PDFDocument
                ...
                date={date}
                month={month}
            />} fileName={`Contrato de Comodato Agille Soluções Corporativas TABLET - ${nome}.pdf`}  >
...
export default ContratosTabAgille