        ...
        <Document>
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.section}>
                    ...
                    <Text>
                        O (A) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> só deverá transportar o Notebook, para ambiente externo à Leve, quando demandado pelo seu gestor imediato,
                        mediante solicitação expressa;
                    </Text>
                    <Text>
                        Nas ocasiões em que o (a) <Text style={{ fontFamily: 'Helvetica-Bold' }}>COMODATÁRIO (A)</Text> desejar transportar o Notebook, para ambiente externo à Leve, sem demanda para a Leve,
    ...
    return (
        <Container>
            ...
            <PDFDownloadLink style={styles.button} document={<PDFDocument
                ...
                date={date}
                month={month}
            />} fileName={`Contrato de Comodato Leve Saúde Operadora NOTEBOOK - ${nome}.pdf`}  >
